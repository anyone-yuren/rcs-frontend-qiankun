...
const BasicElements: FC = () => {
  ...
  return (
    <group>
      {/* 网格 */}
      {showGrid && (
        <Grid args={[500, 500]} fadeDistance={300} sectionColor="#9299a0" sectionSize={10} position={[0, -0.05, 0]} />
      )}
      {/* 轨道控制器 */}
      <OrbitControls makeDefault minDistance={5} maxDistance={200} maxPolarAngle={(Math.PI * 75) / 180} />
